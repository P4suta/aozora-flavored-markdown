...
- **Edit aozora-flavored-markdown source in CodeMirror.** Aozora notation gets a small
...
| Layer | Tech |
|---|---|
| Wasm | `crates/aozora-flavored-markdown-wasm` via `wasm-pack --target bundler` |
...
- **Demoing aozora-flavored-markdown** to someone who doesn't have a Rust toolchain.
